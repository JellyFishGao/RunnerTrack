...
public class RunControllerTest {
    ...
    void shouldCreateNewRun() throws Exception {
        var run = new Run(76,"test", LocalDateTime.now(),LocalDateTime.now().plus(20, ChronoUnit.MINUTES),1, Location.INDOOR);
    ...
    void shouldUpdateRun() throws Exception {
        var run = new Run(2,"test", LocalDateTime.now(),LocalDateTime.now().plus(20, ChronoUnit.MINUTES),1, Location.INDOOR);
